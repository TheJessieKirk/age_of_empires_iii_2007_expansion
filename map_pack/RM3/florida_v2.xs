...
void main(void) {
    ...
    if (rmAllocateSubCivs(5) == true) {
        ...
        if (subCiv2 >= 0) rmSetSubCiv(2, "Jesuit");
...
*/
    ...
    if (subCiv2 == rmGetCivID("Jesuit")) {
        ...
        if (nativeLoc < 0.5) rmPlaceGroupingAtLoc(JesuitVillageID, 0, 0.4, 0.5);
        else rmPlaceGroupingAtLoc(JesuitVillageID, 0, 0.4, 0.5);
    }
    ...
    if (subCiv3 == rmGetCivID("Seminoles")) {
        if (cNumberTeams <= 2) {
            ...
            if (nativeLoc < 0.5) rmPlaceGroupingAtLoc(Seminoles3VillageID, 0, 0.10, 0.5);
            else rmPlaceGroupingAtLoc(Seminoles3VillageID, 0, 0.10, 0.50);
        }
    }
...
*/
    ...
    for (i = 1; < cNumberPlayers) {
        ...
        if (ypIsAsian(i) && rmGetNomadStart() == false) rmPlaceObjectDefAtLoc(ypMonasteryBuilder(i), i, rmPlayerLocXFraction(i), rmPlayerLocZFraction(i));
