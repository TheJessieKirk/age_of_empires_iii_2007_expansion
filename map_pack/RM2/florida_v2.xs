...
void main(void) {
    ...
    if (rmAllocateSubCivs(5) == true) {
        ...
        if (subCiv0 >= 0) rmSetSubCiv(0, "Seminoles");

        subCiv1 = rmGetCivID("Seminoles");
        rmEchoInfo("subCiv1 is Seminoles " + subCiv1);
        if (subCiv1 >= 0) rmSetSubCiv(1, "Seminoles");

        subCiv2 = rmGetCivID("Seminoles");
        rmEchoInfo("subCiv2 is Seminoles " + subCiv2);
        if (subCiv2 >= 0) rmSetSubCiv(2, "Seminoles");

        subCiv3 = rmGetCivID("Seminoles");
        rmEchoInfo("subCiv3 is Seminoles " + subCiv3);
        if (subCiv3 >= 0) rmSetSubCiv(3, "Seminoles");

        if (rmRandFloat(0, 1) < 0.5) {
            subCiv4 = rmGetCivID("Seminoles");
            rmEchoInfo("subCiv4 is Seminoles " + subCiv4);
            if (subCiv4 >= 0) rmSetSubCiv(4, "Seminoles");
        }
    }
    ...
    if (cNumberNonGaiaPlayers > 4) playerTiles = 9000;
    if (cNumberNonGaiaPlayers > 6) playerTiles = 7000;
...
*/
    ...
    if (subCiv0 == rmGetCivID("Seminoles")) {
        if (cNumberTeams <= 2) {
            ...
            if (nativeLoc < 0.5) rmPlaceGroupingAtLoc(SeminolesVillageID, 0, 0.90, 0.50);
            else rmPlaceGroupingAtLoc(SeminolesVillageID, 0, 0.9, 0.5);
        }
    }

    if (subCiv1 == rmGetCivID("Seminoles")) {
        ...
        Seminoles2VillageID = rmCreateGrouping("Seminoles village", "native seminole village " + Seminoles2VillageType);
        ...
        if (nativeLoc < 0.5) rmPlaceGroupingAtLoc(Seminoles2VillageID, 0, 0.6, 0.5);
        else rmPlaceGroupingAtLoc(Seminoles2VillageID, 0, 0.6, 0.5);
    }

    if (subCiv2 == rmGetCivID("Seminoles")) {
        ...
        int Seminoles3VillageType = rmRandInt(1, 5);
        Seminoles3VillageID = rmCreateGrouping("Seminoles village", "native seminole village " + Seminoles3VillageType);
        rmSetGroupingMinDistance(Seminoles3VillageID, 0.0);
        rmSetGroupingMaxDistance(Seminoles3VillageID, 0.0);
        ...
        if (nativeLoc < 0.5) rmPlaceGroupingAtLoc(Seminoles3VillageID, 0, 0.4, 0.5);
        else rmPlaceGroupingAtLoc(Seminoles3VillageID, 0, 0.4, 0.5);
    }
    ...
    if (subCiv3 == rmGetCivID("Seminoles")) {
        if (cNumberTeams <= 2) {
            ...
            int Seminoles4VillageID = -1;
            int Seminoles4VillageType = rmRandInt(1, 5);
            Seminoles4VillageID = rmCreateGrouping("Seminoles village", "native seminole village " + Seminoles4VillageType);
            rmSetGroupingMinDistance(Seminoles4VillageID, 0.0);
            rmSetGroupingMaxDistance(Seminoles4VillageID, 0.0);
            ...
            rmAddGroupingToClass(Seminoles4VillageID, rmClassID("importantItem"));
            if (nativeLoc < 0.5) rmPlaceGroupingAtLoc(Seminoles4VillageID, 0, 0.10, 0.5);
            else rmPlaceGroupingAtLoc(Seminoles4VillageID, 0, 0.10, 0.50);
        }
    }
...
*/
    ...
    if (cNumberTeams <= 2 && teamZeroCount <= 4 && teamOneCount <= 4) {
        ...
        if (randomTeamGrouping <= 0.5) rmSetPlacementSection(0.4, 0.6);
        else rmSetPlacementSection(0.45, 0.55);
        rmSetTeamSpacingModifier(0.5);
        rmPlacePlayersCircular(0.38, 0.38, 0);

        rmSetPlacementTeam(1);
        if (randomTeamGrouping <= 0.5) rmSetPlacementSection(0.9, 0.1);
        else rmSetPlacementSection(0.95, 0.05);
        rmSetTeamSpacingModifier(0.5);
        rmPlacePlayersCircular(0.38, 0.38, 0);
